...
import { GoogleGenAI, GenerateContentResponse } from "@google/genai"; // Import the Gemini model
...
Analyze the provided rooftop image to determine suitable areas for solar panel installation, maximizing the potential solar panel coverage.
      ...
      **Output:**
      ...
      Provide the results like in JSON format without any special character like comma etc, with the following keys:
